...
@register(outgoing=True, pattern=r"^\.kabur(?: |$)(.*)")
async def typewriter(typew):
    typew.pattern_match.group(1)
    await typew.edit("`wih Ada bang Jago.....`")
    sleep(1)
    await typew.edit("`Mending kita kabur aja!!`")
    sleep(1)
    await typew.edit("`🏃 💨`")
    await typew.edit("`🏃   💨`")
    await typew.edit("`🏃     💨`")
    await typew.edit("`🏃       💨`")
    await typew.edit("`🏃   `kecepatan max` ⚡💨💨💨`")
    await typew.edit("`🏃                   💨`")
    await typew.edit("`🏃                  💨`")
    await typew.edit("`🏃                 💨`")
    await typew.edit("`🏃                💨`")
    ...
    await typew.edit("`🏃                    💨`")
    await typew.edit("`🏃                     💨`")
    await typew.edit("`🏃  bang jagonya makin deket ⚡💨`")
    await typew.edit("`🏃                   💨`")
    await typew.edit("`🏃                  💨`")
    await typew.edit("`🏃                 💨`")
    await typew.edit("`🏃                💨`")
    ...
    await typew.edit("`🏃          💨`")
    await typew.edit("`🏃         💨`")
    await typew.edit("`ajg udh di balakang gua!!!`")
    sleep(1)
    await typew.edit("`🏃       💨`")
    await typew.edit("`🏃      💨`")
    await typew.edit("`🏃     💨`")
